...
parser.add_argument("-a1", type=float, default=utils.A1_F500M, help="thermal noise amplitude factor")
parser.add_argument("-a2", type=float, default=utils.A2_F500M, help="flicker noise amplitude factor")
