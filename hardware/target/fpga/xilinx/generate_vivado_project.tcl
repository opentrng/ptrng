...
lappend hdl_files [list "work" [file normalize "${hardware}/target/common/xilinx/vhdl/adc.vhd"]]
lappend hdl_files [list "work" [file normalize "${hardware}/target/common/xilinx/vhdl/ring.vhd"]]
lappend hdl_files [list "work" [file normalize "${hardware}/target/common/xilinx/vhdl/dpfifo.vhd"]]
