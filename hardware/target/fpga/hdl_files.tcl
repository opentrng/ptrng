...
lappend hdl_files [list "opentrng" [file normalize "${hardware}/target/common/generic/fifo.vhd"]]
lappend hdl_files [list "opentrng" [file normalize "${hardware}/config/registers/regmap.vhd"]]
lappend hdl_files [list "opentrng" [file normalize "${hardware}/hdl/analog.vhd"]]
